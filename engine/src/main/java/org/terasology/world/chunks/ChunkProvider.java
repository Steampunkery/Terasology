...
public interface ChunkProvider {
     ...
     */
    ChunkViewCore getLocalView(GridPoint3 centerChunkPos);
     ...
     */
    ChunkViewCore getSubviewAroundBlock(GridPoint3 blockPos, int extent);

    /**
     * @param chunkPos
     * @return A chunk view including the chunks around the given chunk
     */
    ChunkViewCore getSubviewAroundChunk(GridPoint3 chunkPos);
     ...
     */
    void addRelevanceEntity(EntityRef entity, GridPoint3 distance);
     ...
     */
    void addRelevanceEntity(EntityRef entity, GridPoint3 distance, ChunkRegionListener listener);
     ...
     * @param entity
     */
    void updateRelevanceEntity(EntityRef entity, GridPoint3 distance);
     ...
     */
    boolean isChunkReady(GridPoint3 pos);
     ...
     * @return The chunk, or null if the chunk is not ready
     */
    Chunk getChunk(GridPoint3 chunkPos);
