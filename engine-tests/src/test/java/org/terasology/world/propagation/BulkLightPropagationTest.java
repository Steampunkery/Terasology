...
public class BulkLightPropagationTest extends TerasologyTestingEnvironment {
    ...
    public void setup() throws Exception {
        ...
        weakLightData.setBlockFamily(new SymmetricFamily());
        ...
        mediumLightData.setBlockFamily(new SymmetricFamily());
        ...
        solidMediumLightData.setBlockFamily(new SymmetricFamily());
